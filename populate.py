...
def populate():
    ...
    Post.posts.create(title=title1, content=content1, poster=author1, create_time="2022-3-19", parent_module=hot_posts)
    ...
    Post.posts.create(title=title2, content=content2, poster=author1, create_time="2022-3-19", parent_module=hot_posts)
    ...
    for i in range(10):
        try:
            ...
            Post.posts.create(title=(str(i*random.randint(10,98)) + "th tittle"), content=getWords(), poster=uAuthor, create_time="2022-3-18",
                              parent_module=sale)
            Post.posts.create(title=(str(i*random.randint(10,98)) + "th tittle"), content=getWords(), poster=uAuthor, create_time="2022-3-18",
                              parent_module=f)
            Post.posts.create(title=(str(i*random.randint(10,98)) + "th tittle"), content=getWords(), poster=uAuthor, create_time="2022-3-18",
